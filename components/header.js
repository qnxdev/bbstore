    ...
    return (
        <div className='header'>
            <div id='hcont'>
                <Link href='/'>
                    ...
                    <Link href='/apps' className='nomob'>
                        <p className={`headlink nomob${router.pathname.includes('/app') ? " selected":""}`}>Apps</p>
                    </Link>
                    <Link href='/games' className='nomob'>
                        <p className={`headlink nomob${router.pathname.includes('/games') ? " selected":""}`}>Games</p>
                    </Link>
                    <Link href='/tools' className='nomob'>
                        <p className={`headlink nomob${router.pathname.includes('/tools') ? " selected":""}`}>Tools</p>
                    </Link>
                    <Link href='/upload' className='nomob'>
                        <p className={`headlink nomob${router.pathname.includes('/upload') || router.pathname.includes('/edit') ? " selected":""}`}>Contribute</p>
                    </Link>
                <a className='flex' href='https://github.com/qnxdev/bbstore' target='_blank'>
            ...
            <div className='mobile'>
                <Link href='/apps'>
                    <p className={`headlink mob${router.pathname.startsWith('/app') ? " selected":""}`}>Apps</p>
                </Link>
                <Link href='/games'>
                    <p className={`headlink mob${router.pathname.startsWith('/games') ? " selected":""}`}>Games</p>
                </Link>
                <Link href='/tools'>
                    <p className={`headlink mob${router.pathname.startsWith('/tools') ? " selected":""}`}>Tools</p>
                </Link>
                <Link href='/upload'>
                    <p className={`headlink mob${router.pathname.startsWith('/upload')||router.pathname.includes('/edit') ? " selected":""}`}>Contribute</p>
                </Link>
            </div>
            <style jsx>
                {`
