...
export default function Home() {
  const [toprated, setT] = useState([]);
  const [arrivals, setA] = useState([]);
  const firebase = firebaseInit();
  let emptyloader = [0, 0, 0, 0, 0];
        ...
        <div className="top">
          ...
          <div className="array">
            {toprated.length > 0
              ...
              : emptyloader.map((l, index) => (
                  <a
                    id={index == 3 || index == 4 ? "none" : ""}
                    key={index}
                    className="item loaderItems"
                  >
                    <Loader />
                  </a>
                ))}
